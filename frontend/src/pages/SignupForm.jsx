...
function SignupForm() {
    ...
    const handleSubmit = async (e) => {
        ...
        if (chkNickname && chkEmail && chkPassword) {
            // console.log(user)
            try {
    ...
    return (
        <div id='wrap'>
            <form className='signup-form'>
                ...
                <input type="password" id="password" placeholder='비밀번호 입력' value={user.password} onChange={handlePasswordChange} />
                ...
                <input type="date" id="birth" onChange={handleBirth} />
